...
#include "../../../../widgets/widgets/styles/norwegianwoodstyle.h"
...
struct qt_meta_stringdata_NorwegianWoodStyle_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NorwegianWoodStyle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NorwegianWoodStyle_t qt_meta_stringdata_NorwegianWoodStyle = {
    {
QT_MOC_LITERAL(0, 0, 18) // "NorwegianWoodStyle"
...
QT_INIT_METAOBJECT const QMetaObject NorwegianWoodStyle::staticMetaObject = { {
    &QProxyStyle::staticMetaObject,
    qt_meta_stringdata_NorwegianWoodStyle.data,
    qt_meta_data_NorwegianWoodStyle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *NorwegianWoodStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NorwegianWoodStyle.stringdata0))
