...
#ifndef UI_VALIDATORS_H
#define UI_VALIDATORS_H
...
public:
    ...
    {
        ValidatorsForm->setWindowTitle(QApplication::translate("ValidatorsForm", "Validators", nullptr));
