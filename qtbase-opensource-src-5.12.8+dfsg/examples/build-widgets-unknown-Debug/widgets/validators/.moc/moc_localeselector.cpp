...
#include "../../../../widgets/widgets/validators/localeselector.h"
...
void LocaleSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LocaleSelector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (LocaleSelector::*)(const QLocale & );
...
QT_INIT_METAOBJECT const QMetaObject LocaleSelector::staticMetaObject = { {
    &QComboBox::staticMetaObject,
    qt_meta_stringdata_LocaleSelector.data,
    qt_meta_data_LocaleSelector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
