...
#include "../../../../widgets/tools/undoframework/diagramscene.h"
...
void DiagramScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DiagramScene::*)(DiagramItem * , const QPointF & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DiagramScene::itemMoved)) {
                *result = 0;
                return;
            }
        }
