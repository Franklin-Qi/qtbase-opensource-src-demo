...
#include "../../../../examples/network/torrent/addtorrentdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddTorrentDialog_t, stringdata0) + ofs \
...
void AddTorrentDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddTorrentDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AddTorrentDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_AddTorrentDialog.data,
    qt_meta_data_AddTorrentDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AddTorrentDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddTorrentDialog.stringdata0))
