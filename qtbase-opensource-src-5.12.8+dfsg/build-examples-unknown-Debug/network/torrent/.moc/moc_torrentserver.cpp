...
#include "../../../../examples/network/torrent/torrentserver.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TorrentServer_t, stringdata0) + ofs \
...
void TorrentServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TorrentServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TorrentServer::staticMetaObject = { {
    &QTcpServer::staticMetaObject,
    qt_meta_stringdata_TorrentServer.data,
    qt_meta_data_TorrentServer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TorrentServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TorrentServer.stringdata0))
