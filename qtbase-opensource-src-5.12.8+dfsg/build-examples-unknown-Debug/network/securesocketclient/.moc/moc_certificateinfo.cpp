...
#include "../../../../examples/network/securesocketclient/certificateinfo.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CertificateInfo_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CertificateInfo_t qt_meta_stringdata_CertificateInfo = {
    {
QT_MOC_LITERAL(0, 0, 15), // "CertificateInfo"
QT_MOC_LITERAL(1, 16, 21), // "updateCertificateInfo"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 5) // "index"

    },
    "CertificateInfo\0updateCertificateInfo\0"
    "\0index"
};
...
void CertificateInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateCertificateInfo((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject CertificateInfo::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_CertificateInfo.data,
