...
#include "../../../../examples/network/googlesuggest/googlesuggest.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GSuggestCompletion_t, stringdata0) + ofs \
...
void GSuggestCompletion::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GSuggestCompletion *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject GSuggestCompletion::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_GSuggestCompletion.data,
    qt_meta_data_GSuggestCompletion,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GSuggestCompletion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GSuggestCompletion.stringdata0))
