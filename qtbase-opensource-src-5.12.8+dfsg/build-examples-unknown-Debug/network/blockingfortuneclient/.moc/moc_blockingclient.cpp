...
#include "../../../../examples/network/blockingfortuneclient/blockingclient.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BlockingClient_t, stringdata0) + ofs \
...
void BlockingClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BlockingClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject BlockingClient::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_BlockingClient.data,
    qt_meta_data_BlockingClient,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *BlockingClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BlockingClient.stringdata0))
