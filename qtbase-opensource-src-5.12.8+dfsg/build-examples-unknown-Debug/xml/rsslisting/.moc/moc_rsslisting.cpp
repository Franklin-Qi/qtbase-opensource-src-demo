...
#include "../../../../examples/xml/rsslisting/rsslisting.h"
...
void RSSListing::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RSSListing *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject RSSListing::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_RSSListing.data,
    qt_meta_data_RSSListing,
    qt_static_metacall,
    nullptr,
    nullptr
} };
