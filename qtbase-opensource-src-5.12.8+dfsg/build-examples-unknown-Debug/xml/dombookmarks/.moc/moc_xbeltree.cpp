...
#include "../../../../examples/xml/dombookmarks/xbeltree.h"
...
QT_MOC_LITERAL(3, 27, 22), // "const QTreeWidgetItem*"
QT_MOC_LITERAL(4, 50, 4), // "item"
QT_MOC_LITERAL(5, 55, 6) // "column"

    },
    "XbelTree\0updateDomElement\0\0"
...
void XbelTree::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<XbelTree *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateDomElement((*reinterpret_cast< const QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject XbelTree::staticMetaObject = { {
    &QTreeWidget::staticMetaObject,
    qt_meta_stringdata_XbelTree.data,
    qt_meta_data_XbelTree,
    qt_static_metacall,
    nullptr,
    nullptr
} };
