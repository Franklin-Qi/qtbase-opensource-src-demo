...
#include "../../../../../examples/corelib/tools/customtypesending/window.h"
...
QT_MOC_LITERAL(1, 7, 11), // "messageSent"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 7), // "Message"
QT_MOC_LITERAL(4, 28, 7), // "message"
QT_MOC_LITERAL(5, 36, 10), // "setMessage"
QT_MOC_LITERAL(6, 47, 11) // "sendMessage"

    },
    "Window\0messageSent\0\0Message\0message\0"
    "setMessage\0sendMessage"
};
...
void Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Window::*)(const Message & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::messageSent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Window::messageSent(const Message & _t1)
{
