...
#include "../../../../examples/opengl/computegles31/glwindow.h"
...
QT_MOC_LITERAL(1, 9, 10) // "blurRadius"

    },
    "GLWindow\0blurRadius"
};
...
void GLWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< float*>(_v) = _t->blurRadius(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setBlurRadius(*reinterpret_cast< float*>(_v)); break;
        default: break;
        }
