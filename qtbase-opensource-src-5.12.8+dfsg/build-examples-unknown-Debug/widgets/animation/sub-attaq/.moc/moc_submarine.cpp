...
#include "../../../../../examples/widgets/animation/sub-attaq/submarine.h"
...
void SubMarine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SubMarine *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SubMarine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubMarine::subMarineDestroyed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SubMarine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubMarine::subMarineExecutionFinished)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SubMarine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubMarine::subMarineStateChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SubMarine::staticMetaObject = { {
    &PixmapItem::staticMetaObject,
    qt_meta_stringdata_SubMarine.data,
    qt_meta_data_SubMarine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
