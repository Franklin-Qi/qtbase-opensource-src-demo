...
#include "../../../../../examples/widgets/animation/sub-attaq/submarine_p.h"
...
void MovementState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MovementState *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MovementState::staticMetaObject = { {
    &QAnimationState::staticMetaObject,
    qt_meta_stringdata_MovementState.data,
    qt_meta_data_MovementState,
    qt_static_metacall,
    nullptr,
    nullptr
} };
