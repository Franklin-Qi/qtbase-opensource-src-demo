...
#include "../../../../../examples/widgets/animation/sub-attaq/bomb.h"
...
void Bomb::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Bomb::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Bomb::bombExploded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Bomb::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Bomb::bombExecutionFinished)) {
                *result = 1;
                return;
            }
        }
