...
#include "../../../../../examples/widgets/statemachine/rogue/movementtransition.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MovementTransition_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject MovementTransition::staticMetaObject = { {
    &QEventTransition::staticMetaObject,
    qt_meta_stringdata_MovementTransition.data,
    qt_meta_data_MovementTransition,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MovementTransition::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MovementTransition.stringdata0))
