...
#include "../../../../../examples/widgets/itemviews/stardelegate/stardelegate.h"
...
void StarDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StarDelegate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject StarDelegate::staticMetaObject = { {
    &QStyledItemDelegate::staticMetaObject,
    qt_meta_stringdata_StarDelegate.data,
    qt_meta_data_StarDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
