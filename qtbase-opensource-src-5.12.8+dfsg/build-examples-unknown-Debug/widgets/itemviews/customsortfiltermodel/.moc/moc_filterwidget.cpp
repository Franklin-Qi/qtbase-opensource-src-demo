...
#include "../../../../../examples/widgets/itemviews/customsortfiltermodel/filterwidget.h"
...
void FilterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FilterWidget::filterChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        case 1: *reinterpret_cast< QRegExp::PatternSyntax*>(_v) = _t->patternSyntax(); break;
        default: break;
        }
        ...
        case 1: _t->setPatternSyntax(*reinterpret_cast< QRegExp::PatternSyntax*>(_v)); break;
        default: break;
        }
