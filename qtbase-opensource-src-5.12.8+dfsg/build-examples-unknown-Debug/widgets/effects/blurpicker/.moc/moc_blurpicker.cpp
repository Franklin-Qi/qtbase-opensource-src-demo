...
#include "../../../../../examples/widgets/effects/blurpicker/blurpicker.h"
...
void BlurPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<BlurPicker *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject BlurPicker::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_BlurPicker.data,
    qt_meta_data_BlurPicker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
