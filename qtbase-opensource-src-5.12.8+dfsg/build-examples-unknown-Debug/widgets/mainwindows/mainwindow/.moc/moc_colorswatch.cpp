...
#include "../../../../../examples/widgets/mainwindows/mainwindow/colorswatch.h"
...
void ColorSwatch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ColorSwatch *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ColorSwatch::staticMetaObject = { {
    &QDockWidget::staticMetaObject,
    qt_meta_stringdata_ColorSwatch.data,
    qt_meta_data_ColorSwatch,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BlueTitleBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject BlueTitleBar::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_BlueTitleBar.data,
    qt_meta_data_BlueTitleBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
