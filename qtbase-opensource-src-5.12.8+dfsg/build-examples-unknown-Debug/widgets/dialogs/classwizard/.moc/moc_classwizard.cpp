...
#include "../../../../../examples/widgets/dialogs/classwizard/classwizard.h"
...
QT_INIT_METAOBJECT const QMetaObject ClassWizard::staticMetaObject = { {
    &QWizard::staticMetaObject,
    qt_meta_stringdata_ClassWizard.data,
    qt_meta_data_ClassWizard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ClassInfoPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ClassInfoPage_t qt_meta_stringdata_ClassInfoPage = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ClassInfoPage"
...
QT_INIT_METAOBJECT const QMetaObject ClassInfoPage::staticMetaObject = { {
    &QWizardPage::staticMetaObject,
    qt_meta_stringdata_ClassInfoPage.data,
    qt_meta_data_ClassInfoPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ClassInfoPage.stringdata0))
        return static_cast<void*>(this);
    return QWizardPage::qt_metacast(_clname);
}
...
struct qt_meta_stringdata_CodeStylePage_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CodeStylePage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CodeStylePage_t qt_meta_stringdata_CodeStylePage = {
    {
QT_MOC_LITERAL(0, 0, 13) // "CodeStylePage"
...
static const uint qt_meta_data_CodeStylePage[] = {
...
void CodeStylePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject CodeStylePage::staticMetaObject = { {
    &QWizardPage::staticMetaObject,
    qt_meta_stringdata_CodeStylePage.data,
    qt_meta_data_CodeStylePage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *CodeStylePage::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *CodeStylePage::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CodeStylePage.stringdata0))
        return static_cast<void*>(this);
    return QWizardPage::qt_metacast(_clname);
}

int CodeStylePage::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWizardPage::qt_metacall(_c, _id, _a);
    return _id;
}
struct qt_meta_stringdata_OutputFilesPage_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OutputFilesPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OutputFilesPage_t qt_meta_stringdata_OutputFilesPage = {
    {
QT_MOC_LITERAL(0, 0, 15) // "OutputFilesPage"
...
static const uint qt_meta_data_OutputFilesPage[] = {
...
void OutputFilesPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject OutputFilesPage::staticMetaObject = { {
    &QWizardPage::staticMetaObject,
    qt_meta_stringdata_OutputFilesPage.data,
    qt_meta_data_OutputFilesPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *OutputFilesPage::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *OutputFilesPage::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_OutputFilesPage.stringdata0))
        return static_cast<void*>(this);
    return QWizardPage::qt_metacast(_clname);
}

int OutputFilesPage::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWizardPage::qt_metacall(_c, _id, _a);
    return _id;
}
