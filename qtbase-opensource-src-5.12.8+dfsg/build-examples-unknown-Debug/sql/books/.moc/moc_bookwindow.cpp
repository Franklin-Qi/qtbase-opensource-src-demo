...
#include "../../../../examples/sql/books/bookwindow.h"
...
void BookWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BookWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject BookWindow::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_BookWindow.data,
    qt_meta_data_BookWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
